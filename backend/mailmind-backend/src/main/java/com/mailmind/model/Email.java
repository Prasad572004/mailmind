...
//    private User user;
//
//    @Column(name = "sender", columnDefinition = "TEXT")   // ✅ "from" is reserved
//    private String from;
//
//    @Column(name = "recipient", columnDefinition = "TEXT") // ✅ "to" is reserved
//    private String to;
//
//    @Column(columnDefinition = "TEXT")
//    private String subject;
//
//    @Column(columnDefinition = "TEXT")                     // ✅ LONGTEXT → TEXT
//    private String body;
//
//    @Column(columnDefinition = "TEXT")
